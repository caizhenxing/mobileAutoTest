 ...
 *
 */
public class SvnCreateBranch extends BocBaseDO {
     ...
     * 创建时间
     */
    private Timestamp createDate = SvnCreateBranch.getNowTimestamp();
    
    /**
     * 修改时间
     */
    private Timestamp modifyDate = SvnCreateBranch.getNowTimestamp();
	...
	public void setCreateDate(Timestamp createDate) {
		this.createDate = SvnCreateBranch.getNowTimestamp();
	}
	...
	public void setModifyDate(Timestamp modifyDate) {
		this.modifyDate = SvnCreateBranch.getNowTimestamp();
	}
	...
	public String toString() {
		return "SvnCreateBranch [id=" + id + ", deptId=" + deptId
	...
	public SvnCreateBranch(long id, Long deptId, String deptName, Long batchId,
			String batchName, long svnRepoId, String svnRepoName,
