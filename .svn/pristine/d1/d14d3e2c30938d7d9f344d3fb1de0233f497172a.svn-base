 ...
 * 
 */
public final class FileCommonUtils 
{
	private static Logger log = Logger.getLogger(FileCommonUtils.class);
    public static final String TAG = FileCommonUtils.class.getSimpleName();
...
*/
        ...
        try (InputStreamReader read = new InputStreamReader(new FileInputStream(file), charset);
            ...
            while ((line = reader.readLine()) != null) {
                if (i == 0) {
                    ...
                    fileContent = fileContent + SEP + line;
                }
                i++;
            }   
        } catch (Exception e) {
     ...
     * @throws IOException
     */
    public static void unZipInAsset(String sourceFileName, String outputDir, boolean isReWrite) throws IOException {
     ...
     * @throws IOException
     */
    public static void unZip(String zipPath, String outputDir, boolean isReWrite) throws IOException {
        String outputDirectory = outputDir;
        // 创建解压目标目录
        File file = new File(outputDirectory);
        // 如果目标目录不存在，则创建
     ...
     * @throws IOException 
     */
    public static boolean saveTextValue(String fileName, String content, boolean append) throws IOException {
