...
public class ConfigDO extends BocBaseDO implements Serializable {
    ...
    // 创建时间
    private Timestamp createDate = ConfigDO.getNowTimestamp();
    
    // 修改时间
    private Timestamp modifyDate = ConfigDO.getNowTimestamp();
	...
	public void setCreateDate(Timestamp createDate) {
		this.createDate = ConfigDO.getNowTimestamp();
	}
	...
	public void setModifyDate(Timestamp modifyDate) {
		this.modifyDate = ConfigDO.getNowTimestamp();
	}
	...
	public String toString() {
		return "ConfigDO [id=" + id + ", svnServer=" + svnServer
	...
	public ConfigDO(Long id, String svnServer, String svnServerUserName,
