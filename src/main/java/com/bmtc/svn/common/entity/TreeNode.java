package com.bmtc.svn.common.entity;
...
public class TreeNode implements Comparable<TreeNode>,Serializable{
	...
	public TreeNode(String text, String url, boolean leaf, TreeNode parent,
			List<TreeNode> children, Map<String, String> parameters,
